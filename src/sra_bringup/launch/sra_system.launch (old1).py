...
Starts all Phase 1 nodes in the correct order:
  1. sra_state_machine   — system state tracking (starts first, others depend on it)
  2. sra_command_parser  — LLM interface
  3. sra_task_manager    — inventory, queue, task creation
  4. sra_delivery_sim    — simulated robot executor
  5. sra_voice_input     — microphone capture and transcription
