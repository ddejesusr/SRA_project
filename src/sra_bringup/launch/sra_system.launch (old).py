...
Starts all Phase 1 nodes in the correct order:
  1. sra_command_parser  — LLM interface
  2. sra_task_manager    — inventory, queue, task creation
  3. sra_delivery_sim    — simulated robot executor
  4. sra_voice_input     — microphone capture and transcription
